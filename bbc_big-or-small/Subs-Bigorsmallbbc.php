...
/*
*	bigorsmall_bbc_add_code($codes)
*		- Called with integrate_bbc_codes
*		- Adds new bbc codes to existing array
*/
function bigorsmall_bbc_add_code($codes)
{
	global $txt;
...
/*
*	bigorsmall_bbc_add_button($buttons)
*		- Called with integrate_bbc_buttons
*		- Adds new bbc buttons for use in the editor
*/
function bigorsmall_bbc_add_button($buttons)
{
	global $txt;
	
	$row_position = 1; // Which row are we adding the buttons on (starting at 1)
	$col_position = 10; // which col are we inserting the buttons (starting at 1)
